import reflex as rx
from .wrappers import flex, line
from reflex_icons.BootStrap import BsCurrencyDollar, BsCreditCard, BsHouse, BsBox, BsPieChart
    ...
    return rx.box(
        flex(
            flex(
                ...
                flex(
                    BsCreditCard(mr=2), rx.text("Reflex."), align="center"
                ),
                justify="space-between",
                w="100%",
                align="flex-start",
        ...
        flex(
            flex(
                ...
                flex(
                    flex(
                        rx.link(
                            BsHouse(class_name="active-icon"),
                    ...
                    flex(
                        rx.link(
                            BsCurrencyDollar(font_size="2xl"),
                        ),
                        rx.link(
                            rx.text("Credit"),
                            _hover={"text_decor": "none"},
