...
from .styles import *
from demo.pages.graphing import GraphLiveState
from demo.pages.datatable import DataTableLiveState
    ...
    menu_button = rx.box(
        rx.menu(
            ...
            rx.menu_list(
                ...
                rx.menu_item(
                    rx.link("Contact", href="mailto:alek@reflex.dev", width="100%")
                ),
            ),
        ),
        position="fixed",
...
@rx.page("/graphing", on_load=GraphLiveState.live_stream, meta=meta)
@template
...
@rx.page("/datatable", on_load=DataTableLiveState.live_stream, meta=meta)
@template
